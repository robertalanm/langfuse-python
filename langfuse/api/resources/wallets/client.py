...
from .types.create_wallet_request import CreateWalletRequest
...
class WalletsClient:
    ...
    def create_wallet(self, *, request: CreateWalletRequest) -> Wallet:
        _response = httpx.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment}/", "api/public/wallets"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(Wallet, _response.json())  # type: ignore
...
class AsyncWalletsClient:
    ...
    async def create_wallet(self, *, request: CreateWalletRequest) -> Wallet:
