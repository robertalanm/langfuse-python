...
from .types.create_hotkey_request import CreateHotkeyRequest
from .types.hotkey import Hotkey
...
class HotkeysClient:
    ...
    def create_hotkey(self, *, request: CreateHotkeyRequest) -> Hotkey:
        _response = httpx.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment}/", "api/public/hotkeys"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(Hotkey, _response.json())  # type: ignore
...
class AsyncHotkeysClient:
    def __init__(self, *, environment: str, username: str, password: str):
        self._environment = environment
        self._username = username
        self._password = password

    async def create_hotkey(self, *, request: CreateHotkeyRequest) -> Hotkey:
